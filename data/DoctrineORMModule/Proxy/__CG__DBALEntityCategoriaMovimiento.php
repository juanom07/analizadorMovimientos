 ...
 */
class CategoriaMovimiento extends \DBAL\Entity\CategoriaMovimiento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'descripcion', 'TipoMovimiento'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CategoriaMovimiento $proxy) {
